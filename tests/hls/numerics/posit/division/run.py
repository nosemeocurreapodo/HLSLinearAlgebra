...
CLOCK_PERIOD_NS = "10"
COMPONENT_NAME = "posit_division_hls"
...
def main():
    ...
    run_vitis(workspace_path, include_path, PART, CLOCK_PERIOD_NS, COMPONENT_NAME, TOP_FUNCTION_NAME, SYNTHESIS_FILE, TESTBENCH_FILE, 1, 146)
