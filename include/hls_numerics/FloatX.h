...
{
    FloatX<nbits, ebits> f_int = int(a);
    return f_int;
}
...
{
    FloatX<nbits, ebits> f_int = int(a);
    FloatXUnpacked<nbits, ebits> diff = a - f_int;
    if (FloatXUnpacked<nbits, ebits>(0) < diff)
        f_int += FloatX<nbits, ebits>(1);
    return f_int;
}
...
{
    FloatX<nbits, ebits> f_int = int(a);
    FloatX<nbits, ebits> diff = a - f_int;
    if (diff > FloatX<nbits, ebits>(0))
        f_int += FloatX<nbits, ebits>(1);
    return f_int;
}
